...
const matchCommit = /(chore|feat|fix|cleanup|docs)\((angular|core|docs|focus|electron|ionic|nativescript|node|platform|utils|testing|repo|misc)\):\s(([a-z0-9:\-\s])+)/g.test(
  gitMessage
);
...
if (exitCode === 0) {
  ...
  console.log(
    'possible scopes: angular|core|docs|focus|electron|ionic|nativescript|node|platform|utils|testing|repo|misc (if unsure use "core")'
  );
