...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    if [[ $PACKAGE_VERSION =~ ^[0-9]+\.[0-9]+(\.[0-9]+)?$ ]]; then
      ...
      sed -i "" "s|\0.0.1|$PACKAGE_VERSION|g" {schematics,angular,create-xplat-workspace,electron,electron-angular,ionic,ionic-angular,nativescript,nativescript-angular,web,web-angular,xplat}/package.json
    else 
      ...
      sed -i "" "s|\*|$XPLAT_VERSION|g" {schematics,angular,create-xplat-workspace,electron,electron-angular,ionic,ionic-angular,nativescript,nativescript-angular,web,web-angular,xplat}/package.json
    fi
else
    sed -i "s|exports.xplatVersion = '\*';|exports.xplatVersion = '$XPLAT_VERSION';|g" {angular,electron,electron-angular,ionic,ionic-angular,nativescript,nativescript-angular,web,web-angular,xplat}/src/utils/versions.js
