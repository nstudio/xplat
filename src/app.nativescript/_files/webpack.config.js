  ...
  const config = {
        ...
        new TerserPlugin({
          ...
          terserOptions: {
            ...
            compress: {
              ...
              pure_funcs: ['this._log.debug', 'this._log.error', 'this._log.info', 'this._log.warn'],
              global_defs: {
                __UGLIFIED__: true
              }
            },
    ...
    module: {
      rules: [
        ...
        {
          test: /[\/|\\]app\.css$/,
          use: ['nativescript-dev-webpack/style-hot-loader', { loader: 'css-loader', options: { minimize: false, url: false } }]
        },
        {
          test: /[\/|\\]app\.scss$/,
          use: [
    ...
    plugins: [
      ...
      new CopyWebpackPlugin([{ from: { glob: 'assets/**' } }, { from: { glob: 'fonts/**' } }], {
