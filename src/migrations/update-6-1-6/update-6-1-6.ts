...
import { getJsonFromFile, updateJsonFile, createOrUpdate } from '../../utils';
...
function updateNativeScriptApps(tree: Tree, context: SchematicContext) {
  ...
  const ngAppFactoryPath = join(cwd, 'node_modules/@nstudio/schematics/src/app.nativescript/_files/app/app.module.ngfactory.d.ts');
  // console.log('webpackConfigPath:', webpackConfigPath);
